(function() {
    ...
    function Fingerboard($canvas, args) {
      ...
      this.forEach = function(traversor) {
        return model.forEach(function(note, fret, string) {
          console.log(note);
          return traversor(note["public"](events), fret, string);
        });
      };
    }
  ...
  Model = (function() {
    ...
    Model.prototype.buildInterval = function() {
      var index, intervalValue, intervals, tuning, _i, _ref, _results;
      ...
      return this.forEach(function(note, fret, string) {
        return note.interval = intervals[tuning[string - 1] + fret];
      });
    };
    ...
    Model.prototype.set = function(args) {
      ...
      if (args.strings !== void 0 || args.frets !== void 0 || !this.notes[0][0]) {
        this.fill();
      }
